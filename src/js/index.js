...
personagens.forEach((personagem) => {
  personagem.addEventListener("click", () => {
    ...
    */
    ...
    personagemSelecionado.classList.remove("selecionado");  /* classList retorna um array com as classes do parametro */
    ...
    */
    ...
    imagemJogador1.src = `./src/imagens/MHA/${idSelecionado}.png`;
